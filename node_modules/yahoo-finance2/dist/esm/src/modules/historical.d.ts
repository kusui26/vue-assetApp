...
export declare type HistoricalResult = Array<HistoricalRow>;
...
export default function historical(this: ModuleThis, symbol: string, queryOptionsOverrides: HistoricalOptions, moduleOptions?: ModuleOptionsWithValidateTrue): Promise<HistoricalResult>;
