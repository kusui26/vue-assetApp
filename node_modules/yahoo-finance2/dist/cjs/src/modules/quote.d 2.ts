...
export declare type Quote = QuoteCryptoCurrency | QuoteCurrency | QuoteEtf | QuoteEquity | QuoteFuture | QuoteIndex | QuoteMutualfund | QuoteOption;
export declare type QuoteField = keyof Quote;
export declare type ResultType = "array" | "object" | "map";
export declare type QuoteResponseArray = Quote[];
export declare type QuoteResponseMap = Map<string, Quote>;
export declare type QuoteResponseObject = {
    [key: string]: Quote;
};
